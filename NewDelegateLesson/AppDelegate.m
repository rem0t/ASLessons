...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    patient3.name = @"Nikita";
    patient3.temperature = 35.6f;
    
    ASPatient* patient4 = [[ASPatient alloc]init];
    patient4.name = @"Roma";
    patient4.temperature = 38.5f;
    ...
    NSLog(@"%@ are ypu ok ? %@",patient1.name,[patient1 howAreYou]? @"YES":@"NO");
    NSLog(@"%@ are ypu ok ? %@",patient2.name,[patient2 howAreYou]? @"YES":@"NO");
    NSLog(@"%@ are ypu ok ? %@",patient3.name,[patient3 howAreYou]? @"YES":@"NO");
    NSLog(@"%@ are ypu ok ? %@",patient4.name,[patient4 howAreYou]? @"YES":@"NO");
    return YES;
}
